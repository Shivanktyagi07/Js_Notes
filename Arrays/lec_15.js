...
const heros = ["bheem", "karan", "hanuman"];
...
console.log(Array.from({ name: "Shivank" })); //here we ned to tell that iska keys ka ya value ka kiska array bnau directly convert nhi krta that's why is gives empty array:
