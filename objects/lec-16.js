...
const User = {
  ...
  location: "meerut",
  age: "18",
  "last name": "Tygai", //this property can't access by . (dot) method: that's why we use [] method as discusss below : cuz we can access only those who are valid identifires like name and email and both can be accessed by an .(dot) operator:
};
...
User.greetingTwo = function () {
  console.log(`Hello Mr.${this.name} and email :-> ${this.email}`); // string manipulation:
};
